...
Release. If that asset is temporarily unavailable, the installer automatically
builds it from the Codex Desktop archive instead; this takes longer and uses a
larger download.
